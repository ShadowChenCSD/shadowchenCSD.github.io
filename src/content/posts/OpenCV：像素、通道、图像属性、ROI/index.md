...
|    RGB值    |        颜色         |     RGB值     |         颜色          |     RGB值     |          颜色           |
| :---------: | :-----------------: | :-----------: | :-------------------: | :-----------: | :---------------------: |
|   (0,0,0)   | ![black](black.png) | (127,127,127) |   ![gray](gray.png)   | (255,255,255) |   ![white](white.png)   |
|  (255,0,0)  |  ![blue](blue.png)  |   (0,255,0)   |  ![green](green.png)  |   (0,0,255)   |     ![red](red.png)     |
| (255,255,0) |  ![cyan](cyan.png)  |  (0,255,255)  | ![yellow](yellow.png) |  (255,0,255)  | ![magenta](magenta.png) |
...
​		在**OpenCV**中，通道是**按照`B`通道→`G`通道→`R`通道的顺序存储**的。
