...
​		**RGB色彩空间**是一种比较常见的色彩空间类型，除此以外还有一些其他的色彩空间，比较常见的包括**GRAY色彩空间**、**YCrCb色彩空间**、**HSV色彩空间**、**HLS色彩空间**、**L\*a\*b\*色彩空间**、**L\*u\*v\*色彩空间**、 **Bayer色彩空间** 等。
...
​		Bayer色彩空间**被广泛地应用在CCD和CMOS相机中**，它能够从R、G、B交错表中获取彩色图像。
