...
export const zh_TW: Translation = {
	...
	[Key.animeSubtitle]: "記錄我的二次元之旅，評分來自Bangumi番組計劃",
	[Key.animeTotal]: "總數",
	...
	[Key.animeEmptyLocal]: "請在 src/data/anime.ts 文件中添加信息",

	// 游戏页面
	[Key.gameTitle]: "游戲",
	[Key.gameSubtitle]: "記錄我的游戲歷程，評分來自Bangumi番組計劃",
	[Key.gameTotal]: "總數",
	[Key.gameRating]: "評分",
	[Key.gameStatusPlaying]: "游戲中",
	...
	[Key.gameEmptyLocal]: "請在 src/data/game.ts 文件中添加信息",
